...
public class GreeterWebView : WebKit.WebView {
    ...
    public static JSCore.Value get_default_session_hint (JSCore.Context context, JSCore.Object thisObject, JSCode.String propertyName, out JSCore.Value exception) {
